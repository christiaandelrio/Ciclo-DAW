...
class Producto extends Conexion
{
     ...
     * @return array|null
     */
    public function productoFamila($codF) //Esta función recibe un código en lugar de hacer uso de setters y getters como la función getNombreProducto
    {
     ...
     * @return string|null
     */
    public function getNombreProducto() //Esta función obtiene el nombre de un producto con determinado id
    {                                      
