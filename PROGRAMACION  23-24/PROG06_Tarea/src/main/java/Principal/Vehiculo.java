...
/**
 * Clase que representa un vehículo con atributos como marca, matrícula,
 * kilómetros, etc.
 *
...
public class Vehiculo {
    ...
    //Creamos las variables necesarias encapsulando mediante el modificador private. Accederemos a las mismas con sus getters y setters definidos en esta clase.
    ...
    /**
     * Actualiza el número de kilómetros de un vehículo sumándole los
     * introducidos
     *
     * @param nuevosKms
     */
    ...
    /**
     * Devuelve una cadena con los datos básicos del vehículo.
     *
     * @return Cadena con datos del vehículo.
     */
    public String devuelveDatos() {
        return "\nDatos del vehículo solicitado: Marca " + marca + ", matricula " + matricula + ", precio " + precio + "\n";
    }

    /**
     * Muestra los datos del vehículo por pantalla.
     */
    public void mostrarDatos() {
        System.out.println("Marca " + marca + ", matrícula " + matricula + ", precio " + precio + ", kilómetros " + numKm + ", descripción " + descripcion);
    }
