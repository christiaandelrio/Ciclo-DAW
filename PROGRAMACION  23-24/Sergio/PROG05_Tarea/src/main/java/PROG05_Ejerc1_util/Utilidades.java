...
/**
 * Clase de utilidades que proporciona métodos para mostrar menús y escanear diferentes tipos de datos.
...
public class Utilidades {
    ...
    /**
     * Muestra un mensaje para el usuario solicitando un dato y escanea una cadena de texto
     * @param mensaje Mensaje que se muestra antes de escanear la entrada del usuario.
    ...
    /**
     * Muestra un mensaje para el usuario solicitando un dato y escanea un entero
     * @param mensaje Mensaje que se muestra antes de escanear la entrada del usuario.
    ...
    /**
     * Muestra un mensaje para el usuario solicitando un dato y escanea un double
     * @param mensaje Mensaje que se muestra antes de escanear la entrada del usuario.
