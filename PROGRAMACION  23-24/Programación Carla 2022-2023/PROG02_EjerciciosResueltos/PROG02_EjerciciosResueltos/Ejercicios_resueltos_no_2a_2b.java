...
package com.mycompany.ejercicios_resueltos_no_2a_2b;
import java.util.Scanner;
/**
 *
 * @author yo
 */
public class Ejercicios_resueltos_no_2a_2b {
/*Falta por constatar que los valores introducidos no son iguales.
*Introduciría un condicional (A != B) && (B != C) && (C != A) && a los condicionales para cada variable
*/
