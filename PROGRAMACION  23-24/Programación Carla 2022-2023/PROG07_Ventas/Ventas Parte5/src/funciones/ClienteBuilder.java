...
public class ClienteBuilder implements Builder<Cliente>{
    //Implanta el patrón Builder para los objetos Cliente
    public String dni="";
    public String nome="";
...
//Constructor(Copia de un objeto Cliente    
    ...
    //Métodos para validación de DNI, fecha de nacimiento, e-mail y código postal y comprobación de que los atributos son correctos
    ...
    private boolean checkDatanacemento() {
        ...
        if (datanacemento==null){
            erridx=error("Data de nacemento errónea","Debes indicar unha data de nacemento");
        } else {
