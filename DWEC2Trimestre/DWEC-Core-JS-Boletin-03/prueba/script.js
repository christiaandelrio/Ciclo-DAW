...
function diaDeLaSemana(dia, mes, anno) {
    ...
    let diaSemana =  dia += mes < 3 ? anno-- : anno - 2;
        
    //        ((23 * mes / 9)|0) + dia + 4 + ((anno / 4)|0) - ((anno / 100)|0) + ((anno / 400)|0) ) % 7)|0 ;

    let opera = (23 * mes / 9);
    let operaINT = (23 * mes / 9)|0;
    let operaSAFE =  ((23 * mes / 9)|0);

    opera     =  (23 * mes / 9) + dia + 4;
    operaINT  =  (23 * mes / 9)|0 + dia + 4 ;
    operaSAFE =  ((23 * mes / 9)|0) + dia + 4;

    opera     =  (23 * mes / 9) + dia + 4 + (anno / 4) - (anno / 100);
    operaINT  =  (23 * mes / 9)|0 + dia + 4 + (anno / 4)|0 - (anno / 100)|0;
    operaSAFE =  ((23 * mes / 9)|0) + dia + 4 + ((anno / 4)|0) - ((anno / 100)|0);

    opera     =   (23 * mes / 9) + dia + 4 + (anno / 4) - (anno / 100) + (anno / 400)  ;
    operaINT  =   (23 * mes / 9)|0 + dia + 4 + (anno / 4)|0 - (anno / 100)|0 + (anno / 400)|0  ;
    operaSAFE =   ((23 * mes / 9)|0) + dia + 4 + ((anno / 4)|0) - ((anno / 100)|0) + ((anno / 400)|0)  ;

    opera     =   ((23 * mes / 9) + dia + 4 + (anno / 4) - (anno / 100) + (anno / 400) ) % 7;
    operaINT  =   ((23 * mes / 9)|0 + dia + 4 + (anno / 4)|0 - (anno / 100)|0 + (anno / 400)|0 ) % 7;
    operaSAFE =   (((23 * mes / 9)|0) + dia + 4 + ((anno / 4)|0) - ((anno / 100)|0) + ((anno / 400)|0) ) % 7;

    opera     =   ((23 * mes / 9) + dia + 4 + (anno / 4) - (anno / 100) + (anno / 400) ) % 7;
    operaINT  =   (((23 * mes / 9)|0 + dia + 4 + (anno / 4)|0 - (anno / 100)|0 + (anno / 400)|0 ) % 7)|0;
    operaSAFE =   ((((23 * mes / 9)|0) + dia + 4 + ((anno / 4)|0) - ((anno / 100)|0) + ((anno / 400)|0) ) % 7)|0;
    ...
    switch (diaSemana) {
        ...
        default: return "error grave: " + diaSemana;
    }
}
